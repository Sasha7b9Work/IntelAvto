...
extern PinOut pin_FA;           // Сигнал выбора DAC напряжения питания ИП платы истончика напряжения, активный "0".

extern PinOut pin_ENB_HV;       // Управляющий бит модуля питания HVMP 1K-8K 40W. Должен быть установлен в "0" перед 
