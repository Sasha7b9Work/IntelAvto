...
extern PinOut pin_ENB_HV;       // Управляющий бит модуля питания HVMP 1K-8K 40W.
                                // 0 - выключено
...
extern PinIn pin_FA;        // Вход. Используется для сообщения об ошибке высоковольтного модуля
