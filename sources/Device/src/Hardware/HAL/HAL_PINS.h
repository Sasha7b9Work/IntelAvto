...
extern PinOut pin_DAC_CS1_R;    // Сигнал выбора DAC напряжения питания ИП платы истончика напряжения, активный "0".

extern PinOut pin_DAC_CS2_R;    // Сигнал выбора DAC напряжения высоковольтного модуля платы источника напряжения,
                                // активный лог "1"

extern PinOut pin_DAC_END_R;    // Сигнал завершения теста, вырабатывается ПЛИС по завершению теста

extern PinOut pin_DAC_ENB_HB;   // Управляющий бит модуля питания HVMP 1K-8K 40W. Должен быть установлен в "0" перед 
