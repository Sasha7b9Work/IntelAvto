...
namespace PageSignal1
{
    ...
    Parameter param_N("N",
        &gset.signals[TypeSignal::_1].values12[2], Value(5000, TypeValue::Raw), Value(100000, TypeValue::Raw),
        &gset.signals[TypeSignal::_1].values24[2], Value(5000, TypeValue::Raw), Value(100000, TypeValue::Raw),
        90, 130);
