...
namespace PageSignal5b
{
    VParameter param_Us("Us",
        &gset.signals[TypePicture::_5b_16750_2].values12[0], Voltage(79000), Voltage(101000),
        &gset.signals[TypePicture::_5b_16750_2].values24[0], Voltage(151000), Voltage(202000),
        350, 100);

    TParameter param_td("td",
        &gset.signals[TypePicture::_5b_16750_2].values12[2], Time(40), Time(400),
        &gset.signals[TypePicture::_5b_16750_2].values24[2], Time(100), Time(350),
        230, 160);

    CParameter param_Ri("Ri",
        &gset.signals[TypePicture::_5b_16750_2].values12[1], Counter(1), Counter(10),
        &gset.signals[TypePicture::_5b_16750_2].values24[1], Counter(1), Counter(10),
        90, Parameter::CalculateY(4));

    static CParameter param_N("N",
        &gset.signals[TypePicture::_5b_16750_2].values12[3], Counter(1), Counter(1000),
    ...
    static void AdditionDraw()
    {
        Text("%s     Us*: %d В     Импульсов: %d",
            VoltageMode::TextValue(), VoltageMode::Is12() ? 35 : 59, Device::IsRunning() ? IT6523::RemainedPulses() : param_N.GetValue().ToMU()).Write(
