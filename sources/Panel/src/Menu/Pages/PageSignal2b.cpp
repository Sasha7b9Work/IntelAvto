...
namespace PageSignal2b
{
    Parameter param_Us("Us",
        &gset.signals[TypeSignal::_2b].values12[0], Value(0, TypeValue::Voltage), Value(10000, TypeValue::Voltage),
        &gset.signals[TypeSignal::_2b].values24[0], Value(0, TypeValue::Voltage), Value(10000, TypeValue::Voltage),
        430, 170);

    Parameter param_td("td",
        &gset.signals[TypeSignal::_2b].values12[1], Value(0, TypeValue::Time), Value(10000, TypeValue::Time),
        &gset.signals[TypeSignal::_2b].values24[2], Value(0, TypeValue::Time), Value(10000, TypeValue::Time),
        290, 60);
