...
bool IT6523::_Start(TypeSignal::E type, int num_pulses)
{
    ...
    else if (current == TypeSignal::_4_DIN40839)
    {
        ...
        */
        ...
        SU::MilliUnitsToUnits(gset.voltage_mode.CurrentVolts() * 1000 - PageSignal4::param_Us.GetValue().ToAbsMU(), buffer);
        ...
        SU::MilliUnitsToUnits(gset.voltage_mode.CurrentVolts() * 1000 - PageSignal4::param_Ua.GetValue().ToAbsMU(), buffer);
