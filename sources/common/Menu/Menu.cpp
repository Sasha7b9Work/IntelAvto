...
namespace Menu
{
    ...
    Primitives::Label labelStart(10, 170, "СТАРТ", Color::BLACK, Color::GREEN, Color::WHITE);
    Primitives::Label labelStop(10, 210, "СТОП", Color::BLACK, Color::GREEN, Color::WHITE);
}
