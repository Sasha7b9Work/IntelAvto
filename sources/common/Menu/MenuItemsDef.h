...
#define DEF_CHOICE_3(name, hintRu, hintEn, nameRu1, nameRu2, nameRu3, nameEn1, nameEn2, nameEn3, state, func)       \
...
#define DEF_CHOICE_4(name, hintRu, hintEn,                                                                          \
...
static pchar n##name##En[] = { nameEn1, nameEn2, nameEn3, nameEn4, nullptr };                                       \
static uint8 state##name;                                                                                           \
static Choice name(hintRu, hintEn, n##name##Ru, n##name##En, func, &state##name);

#define DEF_CHOICE_5(name, hintRu, hintEn,                                                                          \
...
static pchar n##name##En[] = { nameEn1, nameEn2, nameEn3, nameEn4, nameEn5, nameEn6, nameEn7, nullptr };            \
static uint8 state##name;                                                                                           \
static Choice name(hintRu, hintEn, n##name##Ru, n##name##En, func, &state##name);
...
static pchar n##name##Ru[] = { nameRu1, nameRu2, nameRu3, nameRu4, nameRu5, nameRu6, nameRu7, nameRu8, nameRu9,     \
    nullptr };                                                                                                      \
static pchar n##name##En[] = { nameEn1, nameEn2, nameEn3, nameEn4, nameEn5, nameEn6, nameEn7, nameEn8, nameEn9,     \
    nullptr };                                                                                                      \
static uint8 state##name;                                                                                           \
static Choice name(hintRu, hintEn, n##name##Ru, n##name##En, func, &state##name);
